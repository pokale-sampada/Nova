...
class ActionProfileInfo(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        response1 = """Your Gross Salary is <b>{}</b>.""".format(gross_salary)
        response2 = """Your Basic Salary is <b>{}</b>.""".format(basic_salary)
        response3 = """Your PF Number is <b>{}</b>.""".format(pf_number)
        response4 = """Your UAN Number is <b>{}</b>.""".format(uan_number)
        response5 = """Your ESIC Number is  <b>{}</b>.""".format(esic_number)
        response6 = """Your Employee ID is <b>{}</b>.""".format(emp_code)
        response7 = """Your Name <b>{}</b>.""".format(first_name + " " + last_name)
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if emp_code is None or password is None:
            ...
            try:
                ...
                if status_code != 1:
                    response3 = """You have joined us on  <b>{}</b>.""".format(doj)
...
class ActionGetDesignation(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        try:
            ...
            if status_code != 1:
                response3 = """You are working as a  <b>{}</b>.""".format(designation)
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if emp_code is None or password is None:
            ...
            try:
                ...
                if status_code != 1:
                    response3 = """Currently you are with  <b>{}</b>.""".format(grade)
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if emp_code is None or password is None:
            ...
            try:
                ...
                if status_code != 1:
                    response3 = """Your annual CTC is Rs. <b>{}</b>.""".format(anual_ctc)
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if emp_code is None or password is None:
            ...
            try:
                ...
                if status_code != 1:
                    response3 = """Your Monthly Gross Salary is  Rs.<b>{}</b>.""".format(gross_salary)
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if emp_code is None or password is None:
            ...
            try:
                ...
                if status_code != 1:
                    response3 = """Your Monthly Basic Salary is Rs.<b>{}</b>""".format(basic_salary)
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if emp_code is None or password is None:
            ...
            try:
                ...
                if status_code != 1:
                    response3 = """Your UAN number is <b>{}</b>.""".format(uan_number)
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        if emp_code is None or password is None:
            ...
            try:
                ...
                if status_code != 1:
                    response3 = """Your ESIC insurance number is  <b>{}</b>.""".format(esic_number)
