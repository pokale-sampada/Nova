...
def new_message():  
  ...
  confidences = [confidence_tte,confidence_leave_mgmt,confidence_profile_info,confidence_leave_approval]
  ...
  allskill = ["TTE Skill","Leave Management","Profile Info","Leave Approval"]
